...
export class AppComponent {
  title = 'Managewise-reportes';
	...
	export class AppComponent implements OnInit {
	  ...
	  options = [
      { icon: 'task', path: '/tasks', title: 'Tareas'},
	    { icon: 'event available', path: '/reports', title: 'Calendario'},
	    { icon: 'group', path: '/reports', title: 'Miembros'},
	    { icon: 'check', path: '/reports', title: 'Reporte/Comentarios'},
	    { icon: 'handyman', path:'/reports', title: 'Herramientas'},
	    { icon: 'settings applications', path:'/reports', title: 'Configuracion'},
	    { icon: 'face', path:'/reports', title: 'Profile'}
	  ];
